<template>
    <div class="home" ref="home">
        ...
        <div id="cesiumContainer" ref="getMap"></div>
        ...
        <div class="menu">
            <el-button type="primary" plain @click="getMyPosition"
                >位置查询
            </el-button>
            <el-button type="primary" plain @click="getMyDistance"
                >距离测量</el-button
            >
            <!-- <el-button type="primary" plain @click="getHotMap">热力图  </el-button> -->
            <el-button type="primary" plain @click="getMapPhoto"
                >专题图
            </el-button>
    ...
    methods: {
        ...
        initMap() {
            ...
            window.viewer = new Cesium.Viewer("cesiumContainer", {
                ...
                imageryProvider : new Cesium.UrlTemplateImageryProvider({
                    url: "http://127.0.0.1:8300/sdc/tiles/anno/{z}/{x}/{reverseY}.jpg",
        ...
        getMyPosition() {
            ...
            vhandler.setInputAction(function (event) {
                var myEarthPosition = viewer.camera.pickEllipsoid(
                    event.position,
                ...
                var lat = Cesium.Math.toDegrees(cartographic.latitude).toFixed(
                    2
                );
                var lng = Cesium.Math.toDegrees(cartographic.longitude).toFixed(
                    2
                );
                var height = (
                ...
                viewer.scene.postRender.addEventListener(function (e) {
                    ...
                    //     myEarthPosition
                    // );
                    var newpoi = viewer.scene.cartesianToCanvasCoordinates(
                        myEarthPosition
                    ); //屏幕坐标
